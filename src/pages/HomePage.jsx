          ...
          <Row className="header-box d-flex align-items-center pt-5">
            <Col lg="6">
              ...
              <p className="mb-4 animate__animated animate__fadeInUp animate__delay-1s">
                <span className="fw-bold fs-4">BuildW_t🏆Tegar.</span>{" "}
                Pembimbing Coding buka Pintu Menuju Masa Depanmu!
              </p>
              <button
          ...
          <Row>
            <Col>
              ...
              <p className="text-center">
                Di sini kamu akan dibimbing secara terstruktur step by step
                hingga mahir, sehingga kamu akan bisa menerapkan ketrampilanmu
              ...
              {dataSwiper.map((data) => {
                return (
                  <SwiperSlide key={data.id} className="shadow-sm">
                    ...
                    <div
                      className="people d-flex align-items-center w-100"
